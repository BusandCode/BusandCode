...
const Contact = () => {
  ...
  const contactOptions = [
    ...
    },
    {
      ...
      link: "https://www.linkedin.com/in/adetokunbo-andrew-225a424a",
      linkText: "Send a message"
    },
    {
      icon: FaGithub,
      title: "Github",
      value: "AndrewToks",
      link: "https://github.com/AndrewToks",
          ...
          <div className="lg:col-span-8">
            ...
            >
              ...
              <button
                ...
                className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-orange-500 to-orange-600 
