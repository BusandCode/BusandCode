...
const NavBar = () => {
  return (
    <nav className='bg-[url(/header-bg-color.png)] bg-no-repeat bg-center bg-auto'>
        <div className='flex justify-around gap-5 items-center px-5'>
            <small className='text-[#1E1E1E] text-[40px] py-4 font-semibold'>BusandCode<span className='w-[10px] h-[10px] text-[#EC1552]'>.</span></small>
            ...
            <div className='flex cursor-pointer justify-center bg-[#ffffff] items-center gap-4 text-[18px] border-[1px] w-[193px] rounded-[100px] h-[64px] text-[#4D4D4D] border-[#A7A7A7]'>
